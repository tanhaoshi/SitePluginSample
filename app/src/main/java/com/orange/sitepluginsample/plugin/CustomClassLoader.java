...
class CustomClassLoader extends DexClassLoader {
    ...
    CustomClassLoader(String dexPath, String optimizedDirectory, String libraryPath, ClassLoader parent) {
    ...
    static CustomClassLoader getPluginClassLoader(File plugin, String packageName) {
        ...
        Log.d(TAG, "parent ClassLoader:" + MyApplication.getInstance().getClassLoader().getClass().getCanonicalName());
